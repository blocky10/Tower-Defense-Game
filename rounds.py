...
easy_map_rounds = [
                    ...
                    [
                        {
                            constants.ENEMY_IMAGE: constants.NORMAL_DOG_IMAGE,    
                            constants.NUMBER_OF_ENEMIES: 10,
                            constants.ENEMY_HEALTH: constants.NORMAL_DOG_HEALTH,
                            constants.ENEMY_SPEED: constants.NORMAL_DOG_SPEED,
                            constants.ENEMY_IMAGE_SIZE: constants.NORMAL_DOG_IMAGE_SIZE
                        }
                    ],
                    # Round 2
                    [
                    ...
                    [
                        {
                            constants.ENEMY_IMAGE: constants.FAST_DOG_IMAGE,    
                            constants.NUMBER_OF_ENEMIES: 10,
                            constants.ENEMY_HEALTH: constants.FAST_DOG_HEALTH,
                            constants.ENEMY_SPEED: constants.FAST_DOG_SPEED,
                            constants.ENEMY_IMAGE_SIZE: constants.FAST_DOG_IMAGE_SIZE
                        }
                    ],
                    # Round 4
                    [
